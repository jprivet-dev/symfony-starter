...
* [Generate your reproducer and contribute to Symfony](.starter/docs/contrib.md) — see [existing reproducers](https://github.com/jprivet-dev/symfony-starter/branches/all?query=reproducer%2F).
