...
All commands run in `/symfony-starter`.

 See full [Generate your reproducer and contribute to Symfony](contrib.md) documentation.
...
* [Generate your reproducer and contribute to Symfony](contrib.md)
