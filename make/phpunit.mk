...
.PHONY: phpunit p
phpunit p: _phpunit ## Run PHPUnit | [a=<arguments>] | a="tests/myTest.php"
	@printf "\n$(Y)--- PHPUnit ---$(S)\n"
	$(PHPUNIT) $(a)
...
coverage: _phpunit ## Generate code coverage report in HTML format | [a=<arguments>] | a="tests/myTest.php"
...
.PHONY: dox
dox: _phpunit ## Report test execution progress in TestDox format | [a=<arguments>] | a="tests/myTest.php"
	@printf "\n$(Y)--- PHPUnit TestDox ---$(S)\n"
	$(PHPUNIT) --testdox $(a)
